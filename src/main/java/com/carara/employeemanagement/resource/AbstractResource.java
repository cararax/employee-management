...
import com.carara.employeemanagement.mapper.AbstractMapper;
import com.carara.employeemanagement.service.AbstractService;
...
@AllArgsConstructor
public class AbstractResource<D, T, I, ID, M extends AbstractMapper<D, T, I>, R extends JpaRepository<D, ID>, S extends AbstractService<D, T, I, ID, M, R>> {    protected S service;
