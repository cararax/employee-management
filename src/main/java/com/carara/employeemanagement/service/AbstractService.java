...
import com.carara.employeemanagement.exception.ObjectNotFoundException;
...
public abstract class AbstractService<D, T, I, ID, M extends AbstractMapper<D, T, I>, R extends JpaRepository<D, ID>> {
    ...
    private D exist(ID id) {
        return repository.findById(id)
                .orElseThrow(() -> new ObjectNotFoundException(String.format("Not found regitstry with code %d", id)));
    }
